...
**Generated:** 2025-06-26 02:57:48  
**Original File:** p590a_5.pdf
...
duced (phased out) if your modified AGI is:                         with your spouse or file a joint return, your deduction is
    ...
    • Less than $10,000 for a married individual filing a sep-      creased. For 2025, your Roth IRA contribution limit is re-
      arate return.                                                 duced (phased out) in the following situations.
...
Publication 590-A (2024)                                     Chapter 1   Traditional IRAs                                                  7
...
means the:                                                           This is the most that can be contributed regardless of
 ...
 • Naval Reserve,                                                 fied reservist repayments don’t affect this limit.
...
Publication 590-A (2024)                       Chapter 1       Traditional IRAs                                              9
...
tribute up to $8,000 to your IRA for 2024 if you file a joint       Traditional IRA, earlier. Even if contributions can’t be made
...
lesser of:                                                        year is the calendar year.
 ...
 2. The total compensation includible in the gross income         contributed or allocated to your account for the plan year
...
status, as explained later under Deduction Phaseout.                             on your filing status and modified AGI as shown in Ta-
...
2
   ...
   Lived apart from spouse. If you didn’t live with your                              • Student loan interest deduction.
...
14                                                            Chapter 1        Traditional IRAs                      Publication 590-A (2024)
...
any, is your nondeductible contribution.                                                                        A Form 8606 isn’t used for the year that you make
   ...
   Example. You are 29 years old and single. In 2024,                                                   CAUTION ditional IRA and the rollover includes nontaxable
...
pay a $50 penalty if you don’t file a required Form 8606,          $175 ($7,000 − $6,825) of nondeductible contributions in
...
1.   Enter applicable amount from table above . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                             1.   240,000
...
qualify for an automatic waiver if all of the following apply.          talization, incarceration, serious illness, restrictions im-
 ...
 • The funds aren’t deposited into a plan or IRA within             IRA one-rollover-per-year rule.
    ...
    on the part of the financial institution.                       requirement, go to RetirementPlans-FAQs.
...
distributed, within the same 1-year period, from the IRA             Additional Taxes.
into which you made the tax-free rollover.                           Required distributions. Amounts that must be distrib-
   The 1-year period begins on the date you receive the              uted during a particular year under the required distribu-
IRA distribution, not on the date you roll it over into an IRA.      tion rules (discussed in Pub. 590-B) aren’t eligible for roll-
Rules apply to the number of rollovers you can have with             over treatment.
your traditional IRAs. See Application of one-roll-
over-per-year limitation, later.                                     Inherited IRAs. If you inherit a traditional IRA from your
                                                                     spouse, you can generally roll it over, or you can choose to
   Example. You have two traditional IRAs, IRA-1 and                 make the inherited IRA your own as discussed earlier un-
IRA-2. In 2024, you made a tax-free rollover of a distribu-          der What if You Inherit an IRA.
tion from IRA-1 into a new traditional IRA (IRA-3). You
can’t, within 1 year of the distribution from IRA-1, make a          Reporting rollovers from IRAs. Report any rollover
tax-free rollover of any distribution from either IRA-1 or           from one traditional IRA to the same or another traditional
IRA-3 into another traditional IRA.                                  IRA on Form 1040, 1040-SR, or 1040-NR, lines 4a and
   For 2024, the rollover from IRA-1 into IRA-3 prevents             4b.
you from making a tax-free rollover from IRA-2 into any                 Enter the total amount of the distribution on Form 1040,
other traditional IRA. This is because in 2024 you are only          1040-SR, or 1040-NR, line 4a. If the total amount on Form
allowed to make one rollover within a 1-year period. So,             1040, 1040-SR, or 1040-NR, line 4a, was rolled over, en-
when you make a rollover from IRA-1 to IRA-3, you can’t              ter zero on Form 1040, 1040-SR, or 1040-NR, line 4b. If
make a rollover from IRA-2 to any other traditional IRA.             the total distribution wasn't rolled over, enter the taxable
  Exception. An IRA distribution made from a failed fi-              portion of the part that wasn't rolled over on Form 1040,
nancial institution by the Federal Deposit Insurance Cor-            1040-SR, or 1040-NR, line 4b. Enter "Rollover" next to
poration as receiver is not treated as a rollover for purpo-         line 4b. See your tax return instructions.
ses of the one-rollover-per-year limitation, provided:                  If you rolled over the distribution into a qualified plan
                                                                     (other than an IRA) or you make the rollover in 2025, at-
 1. Neither the failed financial institution nor the depositor       tach a statement explaining what you did.
    initiated the distribution, and                                     For information on how to figure the taxable portion,
...
can make only one rollover from an IRA to another (or the            You can roll over into a traditional IRA all or part of an eligi-
same) IRA in any 1-year period regardless of the number              ble rollover distribution you receive from your (or your de-
of IRAs you own. The limit will apply by aggregating all of          ceased spouse's):
an individual's IRAs, traditional, Roth, SEP, and SIMPLE               • Employer's qualified pension, profit-sharing, or stock
IRAs, effectively treating them as one IRA for purposes of               bonus plan;
the limit. However, trustee-to-trustee transfers between
IRAs aren’t limited and rollovers from traditional IRAs to             • Annuity plan;
Roth IRAs (conversions) aren’t limited.                                • Tax-sheltered annuity plan (section 403(b) plan); or
  Example. You have three traditional IRAs: IRA-1,                     • Governmental deferred compensation plan (section
IRA-2, and IRA-3. You didn’t take any distributions from                 457 plan).
your IRAs in 2024. On January 1, 2025, you took a distri-
                                                                        A qualified plan is one that meets the requirements of
bution from IRA-1 and rolled it over into IRA-2 on the same
                                                                     the Internal Revenue Code.
day. For 2025, you can’t roll over any other 2025 IRA distri-
bution, including a rollover distribution involving IRA-3.           Eligible rollover distribution. Generally, an eligible roll-
This wouldn’t apply to a conversion.                                 over distribution is any distribution of all or part of the bal-
...
24                                               Chapter 1        Traditional IRAs                     Publication 590-A (2024)
 1. An RMD (explained under When Must You Withdraw                     • The requirement to withhold tax from the distribution if
    Assets? (Required Minimum Distributions) in Pub.                     it isn’t paid directly to a traditional IRA or another eligi-
    590-B).                                                              ble retirement plan.
 2. A hardship distribution.                                           • The tax treatment of any part of the distribution that
                                                                         you roll over to a traditional IRA or another eligible re-
 3. Any of a series of substantially equal periodic distribu-            tirement plan within 60 days after you receive the dis-
    tions paid at least once a year over:                                tribution.
     a. Your lifetime or life expectancy,                              • Other qualified retirement plan rules, if they apply, in-
     b. The lifetimes or life expectancies of you and your               cluding those for lump-sum distributions, alternate
        beneficiary, or                                                  payees, and cash or deferred arrangements.

     c. A period of 10 years or more.                                  • How the plan receiving the distribution differs from the
                                                                         plan making the distribution in its restrictions and tax
 4. Corrective distributions of excess contributions or ex-              consequences.
 ...
 5. A loan treated as a distribution because it doesn’t sat-            However, you can choose to have a distribution made
    ...
    See the discussion earlier of plan loan offsets (includ-             ded to consider whether you want to elect a direct roll-
    ing qualified plan loan offsets) under Time Limit for                over.
...
amounts that would be taxable and amounts that wouldn’t              Withholding requirement. Generally, if an eligible roll-
be taxable if they were distributed to you but not rolled            over distribution is paid directly to you, the payer must
over. To the extent the distribution is rolled over into a tra-      withhold 20% of it. This applies even if you plan to roll over
ditional IRA, it isn’t includible in your income.                    the distribution to a traditional IRA. You can avoid with-
        Any nontaxable amounts that you roll over into               holding by choosing the direct rollover option, discussed
 TIP your traditional IRA become part of your basis                  later.
...
IRA.                                                                          The amount withheld is part of the distribution. If
    You will determine your RMDs in years after you make                !     you roll over less than the full amount of the distri-
                                                                      CAUTION bution, you may have to include in your income
the rollover based on whether the employee died before
their required beginning date for taking distributions from          the amount you don’t roll over. However, you can make up
the plan. For more information, see Distributions after the          the amount withheld with funds from other sources.
...
tion. It must tell you about all of the following.                   periodic distribution. For either of these types of distribu-
 ...
 • Your right to have the distribution paid tax free directly        more information, see Pub. 505.
    to a traditional IRA or another eligible retirement plan.

Publication 590-A (2024)                         Chapter 1        Traditional IRAs                                                 25
Direct rollover option. Your employer's qualified plan                        employee's elective contributions to a 401(k) plan, which
must give you the option to have any part of an eligible                      aren’t deductible by the employee.
rollover distribution paid directly to a traditional IRA. The                    If you receive a distribution from your employer's quali-
plan isn’t required to give you this option if your eligible                  fied plan of any part of the balance of your DECs and the
rollover distributions are expected to total less than $200                   earnings from them, you can roll over any part of the distri-
for the year.                                                                 bution.
   Withholding. If you choose the direct rollover option,                     No waiting period between rollovers. The once-a-year
no tax is withheld from any part of the designated distribu-                  limit on IRA-to-IRA rollovers doesn’t apply to eligible roll-
tion that is directly paid to the trustee of the traditional IRA.             over distributions from an employer plan. You can roll over
   If any part is paid to you, the payer must withhold 20%                    more than one distribution from the same employer plan
of that part's taxable amount.                                                within a year.
Choosing an option. Table 1-5 may help you decide                             IRA as a holding account (conduit IRA) for rollovers
which distribution option to choose. Carefully compare the                    to other eligible plans. If you receive an eligible rollover
effects of each option.                                                       distribution from your employer's plan, you can roll over
                                                                              part or all of it into one or more conduit IRAs. You can later
Table 1-5. Comparison of Payment to You Versus Di-                            roll over those assets into a new employer's plan. You can
 ...
 Affected item    you                           direct rollover               other than your employer's plan. However, if you make
                  The payer must withhold            There is no              regular contributions to the conduit IRA or add funds from
 Withholding
                  20% of the taxable part.           withholding.             other sources, the qualified plan into which you move
                  If you are under age 591/2,                                 funds won’t be eligible for any optional tax treatment for
...
26                                                       Chapter 1         Traditional IRAs                    Publication 590-A (2024)
$50,000 in cash and $50,000 in stock. The stock wasn’t                 tribution from a Keogh plan (a qualified plan with at least
stock of your employer. On September 24, you sold the                  one self-employed participant), you can roll over all or part
stock for $60,000. On October 6, you rolled over $110,000              of the distribution (including a lump-sum distribution) into
in cash ($50,000 from the original distribution and $60,000            a traditional IRA. For information on lump-sum distribu-
from the sale of stock). You don’t include the $10,000 gain            tions, see Lump-Sum Distributions under Taxation of Non-
from the sale of stock as part of your income because you              periodic Payments in Pub. 575.
rolled over the entire amount into a traditional IRA.
                                                                          More information. For more information about Keogh
   Note. Special rules may apply to distributions of em-               plans, see chapter 4 of Pub. 560.
...
Partial rollover. If you received both cash and property,              a traditional IRA.
or just property, but didn’t roll over the entire distribution,           Receipt of property other than money. If you re-
see Rollovers in Pub. 575.                                             ceive property other than money, you can sell the property
                                                                       and roll over the proceeds as discussed earlier.
Life insurance contract. You can’t roll over a life insur-
ance contract from a qualified plan into a traditional IRA.            Rollover from bond purchase plan. If you redeem re-
...
tional IRA. You can also roll over all or any part of a distri-        Reporting rollovers from employer plans. Enter the
bution of DECs.                                                        total distribution (before income tax or other deductions
...
into a traditional IRA. To qualify, the distribution must be:
 ...
 • One that would have been an eligible rollover distribu-             if zero, on Form 1040, 1040-SR, or 1040-NR, line 5b. Also,
    tion (defined earlier) if it had been made to the em-              enter "Rollover" next to line 5b of Form 1040, 1040-SR, or
    ployee, and                                                        1040-NR.
...
plan.
   Tax treatment if all of an eligible distribution isn’t              Transfer methods. There are two commonly used meth-
rolled over. Any part of an eligible rollover distribution             ods of transferring IRA assets to a spouse or former
that you keep is taxable in the year you receive it. If you            spouse. The methods are:
don’t roll over any of it, special rules for lump-sum distribu-          • Changing the name on the IRA, and
tions may apply. See Lump-Sum Distributions under Taxa-
tion of Nonperiodic Payments in Pub. 575. The 10% addi-                  • Making a direct transfer of IRA assets.
tional tax on early distributions, discussed later under                  Changing the name on the IRA. If all the assets are
What Acts Result in Penalties or Additional Taxes, doesn’t             to be transferred, you can make the transfer by changing
apply.                                                                 the name on the IRA from your name to the name of your
                                                                       spouse or former spouse.
Keogh plans and rollovers. If you are self-employed,
you are generally treated as an employee for rollover pur-                Direct transfer. Under this method, you direct the
poses. Consequently, if you receive an eligible rollover dis-          trustee of the traditional IRA to transfer the affected assets

Publication 590-A (2024)                           Chapter 1        Traditional IRAs                                               27
directly to the trustee of a new or existing traditional IRA                If you must include any amount in your gross in-
set up in the name of your spouse or former spouse.                    !    come, you may have to increase your withholding
   If your spouse or former spouse is allowed to keep their         CAUTION or make estimated tax payments. See Pub. 505.

portion of the IRA assets in your existing IRA, you can di-
rect the trustee to transfer the assets you are permitted to
keep directly to a new or existing traditional IRA set up in        Recharacterizations
your name. The name on the IRA containing your spou-
se's or former spouse's portion of the assets would then            You may be able to treat a contribution made to one type
be changed to show their ownership.                                 of IRA as having been made to a different type of IRA.
                                                                    This is called recharacterizing the contribution.
         If the transfer results in a change in the basis of
     !   the traditional IRA of either spouse, both spouses            To recharacterize a contribution, you must generally
 CAUTION must file Form 8606 and follow the directions in
                                                                    have the contribution transferred from the first IRA (the
the instructions for that form.                                     one to which it was made) to the second IRA in a
                                                                    trustee-to-trustee transfer. If the transfer is made by the
                                                                    due date (including extensions) for your tax return for the
Converting From Any Traditional IRA                                 tax year for which the contribution was made, you can
Into a Roth IRA                                                     elect to treat the contribution as having been originally
                                                                    made to the second IRA instead of to the first IRA. If you
Allowable conversions. You can withdraw all or part of              recharacterize your contribution, you must do all three of
the assets from a traditional IRA and reinvest them (within         the following.
60 days) in a Roth IRA. The amount that you withdraw and
timely contribute (convert) to the Roth IRA is called a con-          • Include in the transfer any net income allocable to the
version contribution. If properly (and timely) rolled over,             contribution. If there was a loss, the net income you
the 10% additional tax on early distributions won’t apply.              must transfer may be a negative amount.
However, a part or all of the distribution from your tradi-           • Report the recharacterization on your tax return for the
tional IRA may be included in gross income and subjected                year during which the contribution was made.
to ordinary income tax.
    You must roll over into the Roth IRA the same property            • Treat the contribution as having been made to the sec-
you received from the traditional IRA. You can roll over                ond IRA on the date that it was actually made to the
part of the withdrawal into a Roth IRA and keep the rest of             first IRA.
it. The amount you keep will generally be taxable (except           No recharacterizations of conversions made in 2018
for the part that is a return of nondeductible contributions)       or later. A conversion of a traditional IRA to a Roth IRA,
and may be subject to the 10% additional tax on early dis-          and a rollover from any other eligible retirement plan to a
tributions. See When Can You Withdraw or Use Assets,                Roth IRA, made in tax years beginning after December
later, for more information on distributions from traditional       31, 2017, cannot be recharacterized as having been made
IRAs and Early Distributions in Pub. 590-B for more infor-          to a traditional IRA. If you made a conversion in the 2017
mation on the tax on early distributions.                           tax year, you had until the due date (including extensions)
    Periodic distributions. If you started taking substan-          for filing the return for that tax year to recharacterize it.
tially equal periodic payments from a traditional IRA, you
can convert the amounts in the traditional IRA to a Roth            No deduction allowed. You can’t deduct the contribution
IRA and then continue the periodic payments. The 10%                to the first IRA. Any net income you transfer with the re-
additional tax on early distributions won’t apply even if the       characterized contribution is treated as earned in the sec-
distributions aren’t qualified distributions (as long as they       ond IRA. The contribution won’t be treated as having been
are part of a series of substantially equal periodic pay-           made to the second IRA to the extent any deduction was
ments).                                                             allowed for the contribution to the first IRA.

Required distributions. You can’t convert amounts that              Conversion by rollover from traditional to Roth IRA.
must be distributed from your traditional IRA for a particu-        You receive a distribution from a traditional IRA in 1 tax
lar year (including the calendar year in which you reach            year. You then roll it over into a Roth IRA within 60 days of
age 73) under the required distribution rules (discussed in         the distribution from the traditional IRA but in the next
Pub. 590-B).                                                        year. For recharacterization purposes, you would treat this
                                                                    transaction as a contribution to the Roth IRA in the year of
Income. You must include in your gross income distribu-             the distribution from the traditional IRA.
tions from a traditional IRA that you would have had to in-
clude in income if you hadn’t converted them into a Roth            Effect of previous tax-free transfers. If an amount has
IRA. These amounts are normally included in income on               been moved from one IRA to another in a tax-free transfer,
your return for the year that you converted them from a tra-        such as a rollover, you generally can’t recharacterize the
ditional IRA to a Roth IRA.                                         amount that was transferred. However, see Traditional IRA
    You don’t include in gross income any part of a distribu-       mistakenly moved to SIMPLE IRA next.
tion from a traditional IRA that is a return of your basis, as         Traditional IRA mistakenly moved to SIMPLE IRA.
discussed under Are Distributions Taxable? in Pub. 590-B.           If you mistakenly roll over or transfer an amount from a

28                                               Chapter 1       Traditional IRAs                   Publication 590-A (2024)
Worksheet 1-3. Determining the Amount of Net Income Due
 ...
 1.    Enter the amount of your IRA contribution for 2025 to be recharacterized . . . . . . . . . . . . . . . . 1.
...
traditional IRA to a SIMPLE IRA, you can later recharac-                                              make the notifications by the date of the transfer. Only one
terize the amount as a contribution to another traditional                                            notification is required if both IRAs are maintained by the
IRA.                                                                                                  same trustee. The notification(s) must include all of the fol-
                                                                                                      lowing information.
Recharacterizing excess contributions. You can re-
characterize only actual contributions. If you are applying                                             • The type and amount of the contribution to the first
excess contributions for prior years as current contribu-                                                   IRA that is to be recharacterized.
tions, you can recharacterize them only if the recharacteri-                                            • The date on which the contribution was made to the
zation would still be timely with respect to the tax year for                                               first IRA and the year for which it was made.
which the applied contributions were actually made.
                                                                                                        • A direction to the trustee of the first IRA to transfer in a
    Example. You contributed more than you were entitled                                                    trustee-to-trustee transfer the amount of the contribu-
to in 2024. You can’t recharacterize the excess contribu-                                                   tion and any net income (or loss) allocable to the con-
tions you made in 2024 after April 15, 2025, because con-                                                   tribution to the trustee of the second IRA.
tributions after that date are no longer timely for 2024.                                               • The name of the trustee of the first IRA and the name
                                                                                                            of the trustee of the second IRA.
Recharacterizing employer contributions. You can’t
recharacterize employer contributions (including elective                                               • Any additional information needed to make the trans-
deferrals) under a SEP or SIMPLE IRA plan as contribu-                                                      fer.
tions to another IRA. SEPs are discussed in chapter 2 of
Pub. 560. SIMPLE plans are discussed in chapter 3 of                                                     In most cases, the net income you must transfer is de-
Pub. 560.                                                                                             termined by your IRA trustee or custodian. If you need to
                                                                                                      determine the applicable net income on IRA contributions
Recharacterization not counted as rollover. The re-                                                   made after 2024 that are recharacterized, use Worksheet
characterization of a contribution is not treated as a roll-                                          1-3. See Regulations section 1.408A-5 for more informa-
over for purposes of the 1-year waiting period described                                              tion.
earlier in this chapter under Rollover From One IRA Into
Another. This is true even if the contribution would have                                             Timing. The election to recharacterize and the transfer
been treated as a rollover contribution by the second IRA                                             must both take place on or before the due date (including
if it had been made directly to the second IRA rather than                                            extensions) for filing your tax return for the tax year for
as a result of a recharacterization of a contribution to the                                          which the contribution was made to the first IRA.
first IRA.                                                                                               Extension. Ordinarily, you must choose to recharac-
                                                                                                      terize a contribution by the due date of the return or the
How Do You Recharacterize a Contribution?                                                             due date including extensions. However, if you miss this
                                                                                                      deadline, you can still recharacterize a contribution if:
To recharacterize a contribution, you must notify both the
trustee of the first IRA (the one to which the contribution                                             • Your return was timely filed for the year the choice
was actually made) and the trustee of the second IRA (the                                                   should have been made; and
one to which the contribution is being moved) that you                                                  • You take appropriate corrective action within 6 months
have elected to treat the contribution as having been                                                       from the due date of your return, excluding extensions.
made to the second IRA rather than the first. You must                                                      For returns due April 15, 2025, this period ends on

Publication 590-A (2024)                                                 Chapter 1             Traditional IRAs                                                          29
      October 15, 2025. When the date for doing any act for         return for the year in which you made them. This means
      tax purposes falls on a Saturday, Sunday, or legal holi-      that, even if you are under age 591/2, the 10% additional
      day, the due date is delayed until the next business          tax may not apply. These withdrawals are explained later.
      day.
     Appropriate corrective action consists of:                     Contributions Returned Before Due
 • Notifying the trustee(s) of your intent to recharacterize,       Date of Return
 • Providing the trustee with all necessary information,            If you made IRA contributions in 2024, you can withdraw
      and                                                           them tax free by the due date of your return. If you have an
 • Having the trustee transfer the contribution.                    extension of time to file your return, you can withdraw
                                                                    them tax free by the extended due date. You can do this if,
Once this is done, you must amend your return to show               for each contribution you withdraw, both of the following
the recharacterization. You have until the regular due date         conditions apply.
for amending a return to do this. Report the recharacteri-
zation on the amended return and write “Filed pursuant to             • You didn’t take a deduction for the contribution.
section 301.9100-2” on the return. You can file your amen-            • You withdraw any interest or other income earned on
ded return electronically if you filed your tax return for              the contribution. You can take into account any loss on
2024 or the prior 2 years (2023 and 2022) electronically.               the contribution while it was in the IRA when calculat-
Returns filed before these 3 tax years or tax returns filed             ing the amount that must be withdrawn. If there was a
by paper must be amended by filing an amended return by                 loss, the net income earned on the contribution may
paper.                                                                  be a negative amount.
    See the Instructions for Form 1040-X for information for
filing the form electronically. See the instructions for the            Note. If you timely filed your 2024 tax return without
form you filed on paper for the address for filing your             withdrawing a contribution that you made in 2024, you can
amended return by paper.                                            still have the contribution returned to you within 6 months
                                                                    of the due date of your 2024 tax return, excluding exten-
...
Election can’t be changed. After the transfer has taken             changes on the amended return (for example, if you repor-
place, you can’t change your election to recharacterize.            ted the contributions as excess contributions on your origi-
                                                                    nal return, include an amended Form 5329 reflecting that
Same trustee. Recharacterizations made with the same                the withdrawn contributions are no longer treated as hav-
trustee can be made by redesignating the first IRA as the           ing been contributed).
...
Reporting a Recharacterization                                      determine the applicable net income on IRA contributions
                                                                    made after 2024 that are returned to you, use Worksheet
...
its instructions. You must treat the contribution as having            Example. On May 2, 2025, when your IRA is worth
been made to the second IRA.                                        $4,800, you make a $1,600 regular contribution to your
More than one IRA. If you have more than one IRA, fig-              IRA. You request that $400 of the May 2, 2025, contribu-
ure the amount to be recharacterized only on the account            tion be returned to you. On February 2, 2026, when the
from which you withdraw the contribution.                           IRA is worth $7,600, the IRA trustee distributes to you the
                                                                    $400 plus net income attributable to the contribution. No
                                                                    other contributions have been made to the IRA for 2025
                                                                    and no distributions have been made.
When Can You Withdraw or                                               The adjusted opening balance is $6,400 ($4,800 +
Use Assets?                                                         $1,600) and the adjusted closing balance is $7,600. The
                                                                    net income due to the May 2, 2025, contribution is $75
                                                                    ($400 x ($7,600 – $6,400) ÷ $6,400). Therefore, the total
You can withdraw or use your traditional IRA assets at any          to be distributed on February 2, 2026, is $475. This is
time. However, a 10% additional tax generally applies if            shown on Worksheet 1-4. Example—Illustrated.
...
30                                                Chapter 1      Traditional IRAs                   Publication 590-A (2024)
                                                                                                         interest or other income must be reported on Form 5329
Last-in first-out rule. If you made more than one regular                                                and, unless the distribution qualifies for an exception to
contribution for the year, your last contribution is consid-                                             the age 591/2 rule, it will be subject to this tax. See Early
ered to be the one that is returned to you first.                                                        Distributions under What Acts Result in Penalties or Addi-
                                                                                                         tional Taxes? in Pub. 590-B.
Earnings Includible in Income
                                                                                                         Excess Contributions Tax
You must include in income any earnings on the contribu-
tions you withdraw. Include the earnings in income for the                                               If any part of these contributions is an excess contribution
year in which you made the contributions, not the year in                                                for 2023, it is subject to a 6% excise tax. You won’t have to
which you withdraw them.                                                                                 pay the 6% tax if any 2023 excess contribution was with-
                                                                                                         drawn by April 15, 2024 (including extensions), and if any
         Generally, except for any part of a withdrawal that
                                                                                                         2024 excess contribution is withdrawn by April 15, 2025
...
as a taxable distribution. Excess contributions can also be                                                             You may be able to treat a contribution made to
recovered tax free as discussed under What Acts Result                                                     TIP one type of IRA as having been made to a differ-
in Penalties or Additional Taxes, later.                                                                         ent type of IRA. This is called recharacterizing the
                                                                                                         contribution. See Recharacterizations, earlier, for more in-
                                                                                                         formation.
Early Distributions Tax
The 10% additional tax on distributions made before you
reach age 591/2 doesn’t apply to these tax-free withdraw-
als of your contributions. However, the distribution of
Worksheet 1-4. Determining the Amount of Net Income Due
               to an IRA Contribution and Total Amount To
               Be Withdrawn From the IRA                                                                                                             Keep for Your Records
 1.       Enter the amount of your IRA contribution for 2025 to be returned to you . . . . . . . . . . . . . . . . . 1.
...
Worksheet 1-4. Example—Illustrated                                                                                                                   Keep for Your Records
 1.       Enter the amount of your IRA contribution for 2025 to be returned to you . . . . . . . . . . . . . . . . . 1.                                                       400
 2.       Enter the fair market value of the IRA immediately prior to the removal of the contribution,
          plus the amount of any distributions, transfers, and recharacterizations made while the
...
Publication 590-A (2024)                                                     Chapter 1             Traditional IRAs                                                             31
...
in prohibited transactions. There are also additional taxes         Effect on you or your beneficiary. If your account stops
for the following activities.                                       being an IRA because you or your beneficiary engaged in
 • Investing in collectibles.                                       a prohibited transaction, the account is treated as distrib-
                                                                    uting all its assets to you at their fair market values on the
 • Making excess contributions.                                     first day of the year. If the total of those values is more
 • Taking early distributions. See Pub. 590-B.                      than your basis in the IRA, you will have a taxable gain
 • Allowing excess amounts to accumulate (failing to                that is includible in your income. For information on figur-
     take required distributions). See Pub. 590-B.                  ing your gain and reporting it in income, see Are Distribu-
                                                                    tions Taxable? in Pub. 590-B. The distribution may be sub-
 • Having unrelated business income.                                ject to additional taxes or penalties.
   There are penalties for overstating the amount of non-              Borrowing on an annuity contract. If you borrow
deductible contributions and for failure to file Form 8606, if      money against your traditional IRA annuity contract, you
required.                                                           must include in your gross income the fair market value of
   This chapter discusses those acts that you should                the annuity contract as of the first day of your tax year. You
avoid and the additional taxes and other costs, including           may have to pay the 10% additional tax on early distribu-
loss of IRA status, that apply if you don’t avoid those acts.       tions discussed in Pub. 590-B.
...
your traditional IRA account or annuity by you, your benefi-        on early distributions discussed in Pub. 590-B.
ciary, or any disqualified person.
                                                                    Trust account set up by an employer or an employee
  Disqualified persons include your fiduciary and mem-              association. Your account or annuity doesn’t lose its IRA
bers of your family (spouse, ancestor, lineal descendant,           treatment if your employer or the employee association
and any spouse of a lineal descendant).                             with whom you have your traditional IRA engages in a pro-
   The following are some examples of prohibited transac-           hibited transaction.
tions with a traditional IRA.                                          Owner participation. If you participate in the prohibi-
 ...
 • Buying property for personal use (present or future)             in a prohibited transaction, that person may be liable for
     with IRA funds.                                                certain taxes. In general, there is a 15% tax on the amount
        If your IRA is invested in nonpublicly traded as-           involved in the prohibited transaction and a 100% addi-
        sets or assets that you directly control, the risk of       tional tax if the transaction isn’t corrected.
     !
CAUTION engaging in a prohibited transaction in connection
                                                                       Loss of IRA status. If the traditional IRA ceases to be
with your account may be increased.                                 an IRA because of a prohibited transaction by you or your
                                                                    beneficiary, you or your beneficiary isn’t liable for these ex-
Fiduciary. For these purposes, a fiduciary includes any-            cise taxes. However, you or your beneficiary may have to
one who does any of the following.                                  pay other taxes, as discussed under Effect on you or your
 ...
 • Provides investment advice to your IRA for a fee, or             The Department of Labor (DOL) has authority to grant ad-
     has any authority or responsibility to do so.                  ministrative exemptions from the prohibited transaction
 • Has any discretionary authority or discretionary re-             provisions of the Employee Retirement Income Security
     sponsibility in administering your IRA.                        Act (ERISA) and the Internal Revenue Code for a class of

32                                               Chapter 1       Traditional IRAs                    Publication 590-A (2024)
transactions or for individual transactions. In order to grant          plan) deposit balance equal to the lowest qualifying
an administrative exemption, the DOL must make the fol-                 balance for any other type of account.
lowing three determinations.
                                                                      • The rate of return on a traditional IRA investment that
 1. The exemption must be administratively feasible.                    qualifies isn’t less than the return on an identical in-
...
Labor website. For information on filing and the process-           If your traditional IRA invests in collectibles, the amount in-
ing of prohibited transactions exemption applications, see          vested is considered distributed to you in the year inves-
Procedures Governing the Filing and Processing of                   ted. You may have to pay the 10% additional tax on early
Prohibited Transaction Exemption Applications.                      distributions discussed in Pub. 590-B.
                                                                        Any amounts that were considered to be distributed
   The following two types of transactions aren’t prohibited        when the investment in the collectible was made, and
transactions if they meet the requirements that follow.             which were included in your income at that time, aren’t in-
 • Payments of cash, property, or other consideration by            cluded in your income when the collectible is actually dis-
    the trustee of your traditional IRA to you (or members          tributed from your IRA.
    of your family).
...
Even if a trustee makes payments to you or your family,               • Metals,
...
ing requirements are met.                                             • Gems,
 1. The payments are for establishing a traditional IRA or            • Stamps,
    for making additional contributions to it.                        • Coins,
...
Publication 590-A (2024)                         Chapter 1       Traditional IRAs                                               33
Excess Contributions                                                • You withdraw the interest or other income earned on
                                                                      the excess contribution.
Generally, an excess contribution is the amount contrib-          You can take into account any loss on the contribution
uted to your traditional IRAs for the year that is more than      while it was in the IRA when calculating the amount that
the smaller of:                                                   must be withdrawn. If there was a loss, the net income you
 • $7,000 ($8,000 if you are age 50 or older), or                 must withdraw may be a negative amount.
                                                                     In most cases, the net income you must transfer will be
 • Your taxable compensation for the year.                        determined by your IRA trustee or custodian. If you need
  The taxable compensation limit applies whether your             to determine the applicable net income you need to with-
contributions are deductible or nondeductible.                    draw, you can use the same method that was used on
    An excess contribution could be the result of your con-       Worksheet 1-3.
tribution, your spouse's contribution, your employer's con-          If you timely filed your 2024 tax return without withdraw-
tribution, or an improper rollover contribution. If your em-      ing a contribution that you made in 2024, you can still have
ployer makes contributions on your behalf to a SEP IRA,           the contribution returned to you within 6 months of the due
see chapter 2 of Pub. 560.                                        date of your 2024 tax return, excluding extensions. If you
                                                                  do, file an amended return with “Filed pursuant to section
Tax on Excess Contributions                                       301.9100-2” written at the top. Report any related earn-
                                                                  ings on the amended return and include an explanation of
In general, if the excess contributions for a year aren’t         the withdrawal. Make any other necessary changes on the
withdrawn by the date your return for the year is due (in-        amended return (for example, if you reported the contribu-
cluding extensions), you are subject to a 6% tax. You must        tions as excess contributions on your original return, in-
pay the 6% tax each year on excess amounts that remain            clude an amended Form 5329 reflecting that the with-
in your traditional IRA at the end of your tax year. The tax      drawn contributions are no longer treated as having been
can’t be more than 6% of the combined value of all your           contributed).
IRAs as of the end of your tax year.
                                                                  How to treat withdrawn interest or other income. You
   The additional tax is figured on Form 5329. For informa-       must include in your gross income the interest or other in-
tion on filing Form 5329, see Reporting Additional Taxes,         come that was earned on the excess contribution. Report
later.                                                            it on your return for the year in which the excess contribu-
   Example. For 2024, you are 45 years old and single.            tion was made. Your withdrawal of interest or other income
Your compensation is $31,000 and you contributed $7,500           may be subject to an additional 10% tax on early distribu-
to your traditional IRA. You have made an excess contribu-        tions discussed in Pub. 590-B.
tion to your IRA of $500 ($7,500 minus the $7,000 limit).             Beginning on or after December 29, 2022, the 10% ad-
The contribution earned $5 interest in 2024 and $6 inter-         ditional tax will not apply to your withdrawal of interest or
est in 2025 before the due date of the return, including ex-      other income, if withdrawn on or before the due date (in-
tensions. You don’t withdraw the $500 or the interest it          cluding extensions) of the income tax return. See Pub.
earned by the due date of your return, including exten-           590-B for more information.
sions.                                                            Form 1099-R. You will receive Form 1099-R indicating
   You figure your additional tax for 2024 by multiplying         the amount of the withdrawal. If the excess contribution
the excess contribution ($500) shown on Form 5329,                was made in a previous tax year, the form will indicate the
line 16, by 0.06, giving you an additional tax liability of       year in which the earnings are taxable.
$30. You enter the tax on Form 5329, line 17, and on
Schedule 2 (Form 1040), line 8. See the filled-in Form               Example. Maria, age 35, made an excess contribution
5329, later.                                                      in 2024 of $1,000, which she withdrew by April 15, 2025,
...
Date of Return                                                    must include the $50 in her gross income for 2024 (the
                                                                  year in which the excess contribution was made).
You won’t have to pay the 6% tax if you withdraw an ex-              Maria doesn’t have to report the excess contribution as
cess contribution made during a tax year and you also             income or pay the 6% additional tax because she with-
withdraw any interest or other income earned on the ex-           drew the excess contribution by the due date of her return.
cess contribution. You must complete your withdrawal by           Maria receives a Form 1099-R showing that the earnings
the date your tax return for that year is due, including ex-      are taxable for 2024.
tensions.
...
draw from your traditional IRA before your tax return is due      In general, you must include all distributions (withdrawals)
if both of the following conditions are met.                      from your traditional IRA in your gross income. However, if
 • No deduction was allowed for the excess contribution.          the following conditions are met, you can withdraw excess

34                                             Chapter 1       Traditional IRAs                   Publication 590-A (2024)
contributions from your IRA and not include the amount                    You can deduct excess contributions for previous years
withdrawn in your gross income.                                        that are still in your traditional IRA. The amount you can
 • Total contributions (other than rollover contributions)             deduct this year is the lesser of the following two amounts.
    for 2024 to your IRA weren’t more than $7,000 ($8,000                • Your maximum IRA deduction for this year minus any
    if you are age 50 or older).                                            amounts contributed to your traditional IRAs for this
 • You didn’t take a deduction for the excess contribution                  year.
   being withdrawn.                                                      • The total excess contributions in your IRAs at the be-
The withdrawal can take place at any time, even after the                   ginning of this year.
...
Excess contribution deducted in an earlier year. If                    contributions remaining at the end of a tax year.
...
Form 1040-X for that year and don’t deduct the excess                  Worksheet 1-5. Excess Contributions Deductible This
contribution on the amended return. Generally, you can                                Year
file an amended return within 3 years after you filed your
return, or 2 years from the time the tax was paid, which-              Use this worksheet to figure the amount of excess
ever is later.                                                         contributions from prior years you can deduct this year.

                                                                        1. Maximum IRA deduction for the current
 Year(s)                 Contribution limit   Contribution limit
                                                                           year . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .   1.
                                              if age 50 or older
                                              at the end of the         2. IRA contributions for the current
                                              year                         year . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .   2.
 2023                          $6,500               $7,500              3. Subtract line 2 from line 1. If zero or less,
 2019 through 2022             $6,000               $7,000                 enter -0- . . . . . . . . . . . . . . . . . . . . . . . . . . . . .    3.
 2013 through 2018             $5,500               $6,500              4. Excess contributions in IRA at beginning of
 2008 through 2012             $5,000               $6,000                 year . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .   4.
 2006 or 2007                  $4,000               $5,000              5. Enter the lesser of line 3 or line 4. This is
 2005                          $4,000               $4,500                 the amount of excess contributions for
                                                                           previous years that you can deduct this
 2002 through 2004             $3,000               $3,500
                                                                           year . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .   5.
 1997 through 2001             $2,000                 —
 before 1997                   $2,250                 —                    Example. You were entitled to contribute to your tradi-
                                                                       tional IRA and deduct $1,000 in 2023 and $1,500 in 2024
Excess due to incorrect rollover information. If an ex-                (the amounts of your taxable compensation for these
cess contribution in your traditional IRA is the result of a           years). For 2023, you contributed $1,400 but could deduct
rollover and the excess occurred because the information               only $1,000. In 2023, $400 is an excess contribution sub-
the plan was required to give you was incorrect, you can               ject to the 6% tax. However, you wouldn’t have to pay the
withdraw the excess contribution. The limits mentioned                 6% tax if you withdrew the excess (including any earnings)
above are increased by the amount of the excess that is                before the due date of your 2023 return. Because you
due to the incorrect information. You will have to amend               didn’t withdraw the excess, you owe excise tax of $24 for
your return for the year in which the excess occurred to               2023. To avoid the excise tax for 2024, you can correct the
correct the reporting of the rollover amounts in that year.            $400 excess amount from 2023 in 2024 if your actual con-
Don’t include in your gross income the part of the excess              tributions are only $1,100 for 2024 (the allowable deducti-
contribution caused by the incorrect information.                      ble contribution of $1,500 minus the $400 excess from
                                                                       2023 you want to treat as a deductible contribution in
Deducting an Excess Contribution in a Later                            2024). You can deduct $1,500 in 2024 (the $1,100 ac-
Year                                                                   tually contributed plus the $400 excess contribution from
                                                                       2023). This is shown on Worksheet 1-5. Example—Illus-
You can’t apply an excess contribution to an earlier year              trated.
...
Publication 590-A (2024)                            Chapter 1       Traditional IRAs                                                                   35
 Form     5329                                 Additional Taxes on Qualified Plans
 ...
 Schedule 2 (Form 1040), line 8, without filing Form 5329. See instructions.
     ...
     15    Excess contributions for 2024 (see instructions) . . . . . . . . . . . . . . . . . .                          15 500
     ...
     17    Additional tax. Enter 6% (0.06) of the smaller of line 16 or the value of your traditional IRAs on December
           31, 2024 (including 2024 contributions made in 2025). Include this amount on Schedule 2 (Form 1040), line 8   17  30
...
36                                                                     Chapter 1              Traditional IRAs                                Publication 590-A (2024)
Worksheet 1-5. Example—Illustrated                                                          Reporting Additional Taxes
...
Closed tax year. A special rule applies if you incorrectly                                  5329. Write your social security number and “2024 Form
...
ute less than the allowable amount) must be reduced by                                       • Distribution code 1 is correctly shown in box 7 of
the amount of the excess contribution deducted in the                                           Forms 1099-R. If distribution code 1 is correctly shown
closed year.                                                                                    in box 7 of all your Forms 1099-R and you owe the ad-
   To figure the amount of excess contributions for previ-                                      ditional tax on the full amount shown on each Form
ous years that you can deduct this year if you incorrectly                                      1099-R, you don’t have to file Form 5239. Instead, see
deducted part of the excess contribution in a closed tax                                        the instructions for Schedule 2 (Form 1040), line 8, in
year, see Worksheet 1-6.                                                                        the Instructions for Form 1040, or the Instructions for
                                                                                                Form 1040-NR, for how to report the 10% additional
Worksheet 1-6. Excess Contributions Deductible This                                             tax directly on that line.
               Year if Any Were Deducted in a                                                • If you rolled over part or all of a distribution from a
               Closed Tax Year                                                                  qualified retirement plan, the part rolled over isn’t sub-
                                                                                                ject to the 10% additional tax on early distributions.
Use this worksheet to figure the amount of excess
                                                                                                See the instructions for Form 1040, or 1040-NR, lines
contributions for prior years that you can deduct this year if                                  4a and 4b or lines 5a and 5b, for how to report the roll-
you incorrectly deducted excess contributions in a closed                                       over.
tax year.
 ...
 3. If line 2 is less than line 1, enter any excess
    ...
    closed tax year. Otherwise, enter -0- . . . . .                        3.               Roth IRAs
 4. Subtract line 3 from line 1 . . . . . . . . . . . . . .                4.
 5. Subtract line 2 from line 4. If zero or less,                                           Reminders
    enter -0- . . . . . . . . . . . . . . . . . . . . . . . . . . . . .    5.
 6. Excess contributions in IRA at beginning of                                             Deemed IRAs. For plan years beginning after 2002, a
    year . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .   6.               qualified employer plan (retirement plan) can maintain a
 ...
 7. Enter the lesser of line 5 or line 6. This is
    ...
    previous years that you can deduct this                                                 separate account or annuity otherwise meets the require-
    year . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .   7.               ments of an IRA, it will be subject only to IRA rules. An
                                                                                            employee's account can be treated as a traditional IRA or
                                                                                            a Roth IRA.


Publication 590-A (2024)                                                        Chapter 2   Roth IRAs                                                    37
     For this purpose, a “qualified employer plan” includes:
 • A qualified pension, profit-sharing, or stock bonus             When Can a Roth IRA Be
      plan (section 401(a) plan);
 • A qualified employee annuity plan (section 403(a)               Opened?
      plan);
                                                                   You can open a Roth IRA at any time. However, the time
 • A tax-sheltered annuity plan (section 403(b) plan); and         for making contributions for any year is limited. See When
 • A deferred compensation plan (section 457 plan)                 Can You Make Contributions, later, under Can You Con-
      maintained by a state, a political subdivision of a state,   tribute to a Roth IRA.
      or an agency or instrumentality of a state or political
      subdivision of a state.
Designated Roth accounts. Designated Roth accounts                 Can You Contribute to a Roth
...
included in your income, but qualified distributions from          Generally, you can contribute to a Roth IRA if you have
these accounts aren’t included in your income. Designa-            taxable compensation (defined later) and your modified
ted Roth accounts aren’t IRAs and shouldn’t be confused            AGI (defined later) is less than:
with Roth IRAs. Contributions, up to their respective limits,       • $240,000 for married filing jointly or qualifying surviv-
can be made to Roth IRAs and designated Roth accounts                  ing spouse;
according to your eligibility to participate. A contribution to
one doesn’t impact your eligibility to contribute to the
                                                                    • $161,000 for single, head of household, or married fil-
...
Introduction                                                               You may be able to claim a credit for contributions
Regardless of your age, you may be able to establish and            TIP to your Roth IRA. For more information, see chap-
make nondeductible contributions to an individual retire-                  ter 3.
ment plan called a Roth IRA.
                                                                   Is there an age limit for contributions? Contributions
Contributions not reported. You don’t report Roth IRA              can be made to your Roth IRA regardless of your age.
...
What Is a Roth IRA?                                                Spousal IRA limit discussed in chapter 1 under How Much
                                                                   Can Be Contributed, you file jointly, and your modified AGI
A Roth IRA is an individual retirement plan that, except as        is less than $240,000.
explained in this chapter, is subject to the rules that apply
to a traditional IRA (defined next). It can be either an ac-       Compensation. Compensation includes wages, salaries,
count or an annuity. Individual retirement accounts and            tips, professional fees, bonuses, and other amounts re-
annuities are described in chapter 1 under How Can a Tra-          ceived for providing personal services. It also includes
ditional IRA Be Opened. Roth IRAs include Roth IRAs that           commissions, self-employment income, nontaxable com-
receive employer contributions from SEP arrangements.              bat pay, military differential pay, taxable alimony and sepa-
                                                                   rate maintenance payments, and taxable non-tuition fel-
   To be a Roth IRA, the account or annuity must be des-           lowship and stipend payments. For more information, see
ignated as a Roth IRA when it is opened.                           What Is Compensation under Who Can Open a Traditional
   Unlike a traditional IRA, you can’t deduct contributions        IRA? in chapter 1.
...
are tax free, and if you choose, you can leave amounts in          is your AGI as shown on your return with some adjust-
your Roth IRA as long as you live.                                 ments. Use Worksheet 2-1 to determine your modified
                                                                   AGI.
...
in chapter 1. SIMPLE IRAs are discussed in Pub. 560.

38                                                    Chapter 2    Roth IRAs                        Publication 590-A (2024)
How Much Can Be Contributed?                                       SEPs and SIMPLE plans are discussed in Pub. 560.
...
IRAs, your contribution limit is generally the lesser of:       distribution.
 • $7,000 ($8,000 if you are age 50 or older), or                  Note. If you make repayments of qualified reservist
...
don’t affect this limit.
 ...
 • $7,000 ($8,000 if you are age 50 or older) minus all                   more than $0, but less than $200, increase the
 ...
 • Your taxable compensation minus all contributions            taxable compensation of $146,000. You want to make the
    (other than employer contributions under a SEP or           maximum allowable contribution to your Roth IRA for
    SIMPLE IRA plan) for the year to all IRAs other than        2024. Your modified AGI for 2024 is $146,000. You haven’t
    Roth IRAs.                                                  contributed to any traditional IRA, so the maximum contri-
   However, if your modified AGI is above a certain             bution limit before the modified AGI reduction is $7,000.
amount, your contribution limit may be reduced, as ex-          You figure your reduced Roth IRA contribution of $6,530
plained later under Contribution limit reduced.                 as shown on Worksheet 2-2. Example—Illustrated.




Publication 590-A (2024)                            Chapter 2   Roth IRAs                                                39
...
40                                                                               Chapter 2             Roth IRAs                                             Publication 590-A (2024)
...
and your filing status is...            AND your modified AGI is...             THEN...
                                                                                ...
                                                                                ($8,000 if you are age 50 or
                                                less than $230,000              older) as explained under How
                                                                                Much Can Be Contributed,
                                                                                earlier.
    married filing jointly or
                                                                                the amount you can contribute
  qualifying surviving spouse
                                                at least $230,000               is reduced as explained under
                                              but less than $240,000            Contribution limit reduced,
                                                                                earlier.
   ...
   at any time during the year)                 more than zero (-0-)            is reduced as explained under
                                               but less than $10,000            Contribution limit reduced,
                                                  ...
                                                  $10,000 or more
                                                                                ...
                                                                                you can contribute up to $7,000
                                                                                ($8,000 if you are age 50 or
                                                less than $146,000              older) as explained under How
                                                                                Much Can Be Contributed,
 single, head of household, or
                                                                                earlier.
    married filing separately
   (and you didn’t live with your                                               the amount you can contribute
  spouse at any time during the                 at least $146,000               is reduced as explained under
              year)                           but less than $161,000            Contribution limit reduced,
                                                                                earlier.
                                                                                you can’t contribute to a Roth
                                                 $161,000 or more
                                                                                IRA.
...
Publication 590-A (2024)                        Chapter 2    Roth IRAs                                               41
...
is, use this worksheet to determine how much it is reduced.
       ...
       2. Enter:
           ...
           • $-0- if married filing a separate return and you lived with your spouse
             at any time in 2024, or
           • $146,000 for all others . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                      2.
       3. Subtract line 2 from line 1 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                     3.
       4. Enter:
...
that year (not including extensions).                                                                          Much Can Be Contributed); plus
            ...
            You can make contributions for 2024 by the due                                                2. Any excess contributions for the preceding year, re-
 TIP date (not including extensions) for filing your 2024                                                    duced by the total of:
        tax return. This means that most people can make                                                        a. Any distributions out of your Roth IRAs for the
contributions for 2024 by April 15, 2025.                                                                          year, plus
...
42                                                                               Chapter 2             Roth IRAs                                         Publication 590-A (2024)
Worksheet 2-2. Example—Illustrated
Before using this worksheet, check Table 2-1 to determine whether or not your Roth IRA contribution limit is reduced. If it
is, use this worksheet to determine how much it is reduced.

     1. Enter your modified AGI for Roth IRA purposes (Worksheet 2-1, line 10) . . . . . . . . . . . . . .                                         1.      147,000

     2. Enter:
         • $230,000 if filing a joint return or qualifying surviving spouse,
         • $-0- if married filing a separate return and you lived with your spouse at any time in
            2024, or
         • $146,000 for all others . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .         2.      146,000
     ...
     6. Enter the lesser of:
         • $7,000 ($8,000 if you are age 50 or older), or
         • Your taxable compensation . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .               6.        7,000
    ...
    11. Enter the lesser of line 8 or line 10. This is your reduced Roth IRA
        contribution limit . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .    11.        6,540

earnings are considered earned and received in the year                                            been made directly to a different IRA. You can roll
the excess contribution was made.                                                                  amounts over from a designated Roth account or from one
   If you timely filed your 2024 tax return without withdraw-                                      Roth IRA to another Roth IRA.
ing a contribution that you made in 2024, you can still have
the contribution returned to you within 6 months of the due                                        Conversions
date of your 2024 tax return, excluding extensions. If you
do, file an amended return with “Filed pursuant to section                                         You can convert a traditional IRA to a Roth IRA. The con-
301.9100-2” written at the top. Report any related earn-                                           version is treated as a rollover, regardless of the conver-
ings on the amended return and include an explanation of                                           sion method used. Most of the rules for rollovers, descri-
the withdrawal. Make any other necessary changes on the                                            bed in chapter 1 under Rollover From One IRA Into
amended return.                                                                                    Another, apply to these rollovers. However, the 1-year
...
Can You Move Amounts Into a                                                                          • Trustee-to-trustee transfer. You can direct the
...
tional or traditional SIMPLE IRA into a Roth IRA or Roth                                                 IRA also maintains the Roth IRA, you can direct the
SIMPLE IRA. You may be able to roll over amounts from a                                                  trustee to transfer an amount from the traditional IRA
qualified retirement plan to a Roth IRA. You may be able to                                              to the Roth IRA.
recharacterize contributions made to one IRA as having


Publication 590-A (2024)                                                    Chapter 2            Roth IRAs                                                       43
   Same trustee. Conversions made with the same                 Any amount rolled over is subject to the same rules for
trustee can be made by redesignating the traditional IRA        converting a traditional IRA into a Roth IRA. See Convert-
as a Roth IRA, rather than opening a new account or issu-       ing From Any Traditional IRA Into a Roth IRA in chapter 1.
ing a new contract.                                             Also, the rollover contribution must meet the rollover re-
                                                                quirements that apply to the specific type of retirement
Qualified tuition program rollover to a Roth IRA. Be-           plan.
ginning with distributions made after December 31, 2023,
a beneficiary of a section 529 qualified tuition program is     Rollover methods. You can roll over amounts from a
permitted to roll over a distribution from the section 529      qualified retirement plan to a Roth IRA in one of the follow-
account to a Roth IRA for the beneficiary if certain require-   ing ways.
ments are met.
                                                                  • Rollover. You can receive a distribution from a quali-
 • The rollover must be paid through a direct                       fied retirement plan and roll it over (contribute it) to a
     trustee-to-trustee transfer to a Roth IRA maintained for       Roth IRA within 60 days after the distribution. Because
     the benefit of the beneficiary.                                the distribution is paid directly to you, the payer must
                                                                    generally withhold 20% of it. For rules about making a
 • The rollover amount for a year cannot be more than
                                                                    rollover of a plan loan offset, including a qualified plan
     the Roth IRA annual contributions limit, and all such
                                                                    loan offset, see Time Limit for Making a Rollover Con-
     rollovers for the individual’s lifetime cannot exceed
                                                                    tribution in chapter 1.
     $35,000.
 • The rollover must be from a section 529 account that           • Direct rollover option. Your employer's qualified plan
 ...
 • The distribution cannot exceed the aggregate amount              ally, no tax is withheld from any part of the designated
     contributed to the program (and earnings attributed to         distribution that is directly paid to the trustee of the
     the contributed amount) before the 5-year period end-          Roth IRA.
     ing on the date of the distribution.
                                                                Rollover by nonspouse beneficiary. If you are a desig-
   A distribution made after December 31, 2024, and be-
                                                                nated beneficiary (other than a surviving spouse) of a de-
fore April 15, 2025, that is rolled over to a Roth IRA by
                                                                ceased employee, you can roll over all or part of an eligi-
April 15, 2025, and designated for 2024 would be reported
                                                                ble rollover distribution from one of the types of plans
as a Roth IRA contribution for 2024.
                                                                listed earlier into a Roth IRA. You must make the rollover
Income. You must include in your gross income distribu-         by a direct trustee-to-trustee transfer into an inherited
tions from a traditional IRA that you would have had to in-     Roth IRA.
clude in income if you hadn’t converted them into a Roth            You will determine your RMDs in years after you make
IRA. These amounts are normally included in income on           the rollover based on whether the employee died before
your return for the year that you converted them from a tra-    their required beginning date for taking distributions from
ditional IRA to a Roth IRA.                                     the plan. For more information, see Distributions after the
                                                                employee’s death under Tax on Excess Accumulation in
        If you must include any amount in your gross in-        Pub. 575.
     !  come, you may have to increase your withholding
CAUTION or make estimated tax payments. See Pub. 505.           Income. You must include in your gross income distribu-
                                                                tions from a qualified retirement plan that you would have
More information. For more information on conversions,          had to include in income if you hadn’t rolled them over into
see Converting From Any Traditional IRA Into a Roth IRA         a Roth IRA. You don’t include in gross income any part of
in chapter 1.                                                   a distribution from a qualified retirement plan that is a re-
                                                                turn of basis (after-tax contributions) to the plan that were
Rollover From Employer's Plan Into a                            taxable to you when paid. These amounts are normally in-
                                                                cluded in income on your return for the year of the rollover
Roth IRA                                                        from the qualified employer plan to a Roth IRA.
You can roll over into a Roth IRA all or part of an eligible             If you must include any amount in your gross in-
rollover distribution you receive from your (or your de-           !     come, you may have to increase your withholding
ceased spouse's):                                                CAUTION or make estimated tax payments. See Pub. 505.


 • Employer's qualified pension, profit-sharing, or stock          For more information on eligible rollover distributions
     bonus plan (including a 401(k) plan);                      from qualified retirement plans and withholding, see Roll-
 • Annuity plan;                                                over From Employer's Plan Into an IRA in chapter 1.
...
44                                                 Chapter 2    Roth IRAs                        Publication 590-A (2024)
Military Death Gratuities and
Servicemembers' Group Life                                     3.
...
the amount received to your Roth IRA. The contribution is      Contributions Credit
...
ESA or another Roth IRA. Any military death gratuity or        What's New
SGLI payment contributed to a Roth IRA is disregarded for
purposes of the 1-year waiting period between rollovers.       Modified AGI limit for retirement savings contribu-
                                                               tions credit increased. For 2024, you may be able to
   The rollover must be completed before the end of the        claim the retirement savings contributions credit if your
1-year period beginning on the date you received the pay-      modified AGI isn’t more than:
ment.
                                                                • $76,500 if your filing status is married filing jointly;
  The amount contributed to your Roth IRA is treated as
part of your cost basis (investment in the contract) in the     • $57,375 if your filing status is head of household; or
Roth IRA that isn’t taxable when distributed.                   • $38,250 if your filing status is single, married filing
                                                                   separately, or qualifying surviving spouse.
Rollover From a Roth IRA
You can withdraw, tax free, all or part of the assets from     Introduction
one Roth IRA if you contribute them within 60 days to an-
other Roth IRA. Most of the rules for rollovers, described     You may be able to take a tax credit if you make eligible
in chapter 1 under Rollover From One IRA Into Another,         contributions (defined later) to a qualified retirement plan,
apply to these rollovers. However, rollovers from retire-      an eligible deferred compensation plan, or an IRA. You
ment plans other than Roth IRAs are disregarded for pur-       may be able to take a credit of up to $1,000 (up to $2,000
poses of the 1-year waiting period between rollovers.          if filing jointly). This credit could reduce the federal income
...
plan isn’t allowed.
  ...
  A rollover from a designated Roth account can only be        tions to a qualified retirement plan, an eligible deferred
made to another designated Roth account or to a Roth           compensation plan, or an IRA, you can claim the credit if
IRA.                                                           all of the following apply.
   If you roll over an amount from one Roth IRA to another      1. You were born before January 2, 2007.
Roth IRA, the 5-year period used to determine qualified
distributions doesn’t change. The 5-year period begins          2. You aren’t a full-time student (explained later).
with the first tax year for which the contribution was made     3. No one else, such as your parent(s), claims you as a
to the initial Roth IRA. See What Are Qualified Distribu-          dependent on their tax return.
tions? in chapter 2 of Pub. 590-B.
                                                                4. Your adjusted gross income (defined later) isn’t more
                                                                   than:
                                                                    a. $76,500 if your filing status is married filing jointly;
                                                                    b. $57,375 if your filing status is head of household;
                                                                       or
...
Publication 590-A (2024)          Chapter 3    Retirement Savings Contributions Credit                                       45
                                                     (Saver's Credit)
 • A student taking a full-time, on-farm training course               a. The distribution is made before the due date (in-
     given by either a school that has a regular teaching                 cluding extensions) of your tax return for that year,
     ...
     students in attendance, or a state, county, or local
                                                                          and
     government.
You are a full-time student if you are enrolled for the num-           c. The distribution includes any income attributable
ber of hours or courses the school considers to be full                   to the contribution.
time.                                                              4. Loans from a qualified employer plan treated as a dis-
   Adjusted gross income (AGI). This is generally the                 tribution.
amount on line 11 of your 2024 Form 1040, 1040-SR, or              5. Distributions of excess contributions or deferrals (and
1040-NR. However, you must add to that amount any ex-                 income attributable to excess contributions and defer-
clusion or deduction claimed for the year for:                        rals).
 • Foreign earned income,                                          6. Distributions of dividends paid on stock held by an
 • Foreign housing costs,                                             employee stock ownership plan under section 404(k).
 • Income for bona fide residents of American Samoa,               7. Distributions from an eligible retirement plan that are
     and                                                              converted or rolled over to a Roth IRA.
 • Income from Puerto Rico.                                        8. Distributions from a military retirement plan.
Eligible contributions. These include:                             9. Distributions from an inherited IRA by a nonspousal
 ...
 2. Salary reduction contributions (elective deferrals, in-       your spouse receives are treated as received by you if you
    cluding amounts designated as after-tax Roth contri-          file a joint return with your spouse both for the year of the
    butions) to:                                                  distribution and for the year for which you claim the credit.
     a. A 401(k) plan (including a SIMPLE 401(k)),                   Testing period. The testing period consists of the year
     b. A section 403(b) annuity,                                 for which you claim the credit, the period after the end of
                                                                  that year and before the due date (including extensions)
     c. An eligible deferred compensation plan of a state         for filing your return for that year, and the 2 tax years be-
        or local government (a governmental 457 plan),            fore that year.
     d. A SIMPLE IRA plan, or
                                                                     Example. You and your spouse filed joint returns in
     e. A salary reduction SEP; and                               2022 and 2023, and plan to do so in 2024 and 2025. You
                                                                  received a taxable distribution from a qualified plan in
 3. Contributions to a section 501(c)(18) plan.                   2022 and a taxable distribution from an eligible deferred
They also include voluntary after-tax employee contribu-          compensation plan in 2023. Your spouse received taxable
tions to a tax-qualified retirement plan or section 403(b)        distributions from a Roth IRA in 2024 and tax-free distribu-
annuity. For purposes of the credit, an employee contribu-        tions from a Roth IRA in 2025 before April 15. You made
tion will be voluntary as long as it isn’t required as a condi-   eligible contributions to an IRA in 2024 and you otherwise
tion of employment.                                               qualify for this credit. You must reduce the amount of your
                                                                  qualifying contributions in 2024 by the total of the distribu-
Reducing eligible contributions. Reduce your eligible             tions you received in 2022, 2023, 2024, and 2025.
...
if the distribution isn’t taxable.                                Effect on other credits. The amount of this credit won’t
    Don’t reduce your eligible contributions by any of the        change the amount of your refundable tax credits. A re-
following.                                                        fundable tax credit, such as the earned income credit or
                                                                  the refundable amount of your child tax credit, is an
 1. The portion of any distribution which isn’t includible in     amount that you would receive as a refund even if you
    income because it is a trustee-to-trustee transfer or a       didn’t otherwise owe any taxes.
 ...
 3. Any distribution that is a return of a contribution to an     any refundable credits) in any year. If your tax liability is re-
    IRA (including a Roth IRA) made during the year for           duced to zero because of other nonrefundable credits,
    which you claim the credit if:

46                                  Chapter 3     Retirement Savings Contributions Credit           Publication 590-A (2024)
                                                        (Saver's Credit)
such as the credit for child and dependent care expenses,            low-to-moderate incomes, persons with disabilities,
then you won’t be entitled to this credit.                           and limited-English-speaking taxpayers who need
...
and your credit rate. Your credit rate can be as low as 10%          ration.
...
your credit rate.                                                    gram offers free tax help for all taxpayers, particularly
   The maximum contribution taken into account is $2,000             those who are 60 years of age and older. TCE volun-
per person. On a joint return, up to $2,000 is taken into ac-        teers specialize in answering questions about pen-
count for each spouse.                                               sions and retirement-related issues unique to seniors.
   Figure the credit on Form 8880. Report the credit on              Go to IRS.gov/TCE or download the free IRS2Go app
Schedule 3 (Form 1040), line 4, and attach Form 8880 to              for information on free tax return preparation.
your return.                                                       • MilTax. Members of the U.S. Armed Forces and quali-
...
Publication 590-A (2024)                                                                                                  49
Filing an amended return. Go to IRS.gov/Form1040X               TAS helps taxpayers resolve problems with the IRS,
for information and updates.                                    makes administrative and legislative recommendations to
                                                                prevent or correct the problems, and protects taxpayer
Checking the status of your amended return. Go to               rights. We work to ensure that every taxpayer is treated
IRS.gov/WMAR to track the status of Form 1040-X amen-           fairly and that you know and understand your rights under
ded returns.                                                    the Taxpayer Bill of Rights. We are Your Voice at the IRS.
        It can take up to 3 weeks from the date you filed
     !  your amended return for it to show up in our sys-       How Can TAS Help Me?
...
IRS Document Upload Tool. You may be able use the                   cluding individuals, businesses, and exempt organiza-
Document Upload Tool to respond digitally to eligible IRS           tions. You may be eligible for TAS help if your IRS
...
tions can be answered on IRS.gov without visiting a TAC.        How Do I Contact TAS?
...
Is Here To Help You                                             equitable way.
...
clude worksheets and tables.                                                       fits.
 ...
 1. Appendix A—Summary Record                Modified AGI.                      d. Comprehensive Example and
    of Traditional IRA(s) for 2024.                                                completed worksheets.
                                          b. Worksheet 2, Computation of
 2. Appendix B—Worksheets you                Traditional IRA Deduction for   3. Appendix C—Line 1 Worksheet.
    use if you receive social security       2024.
    benefits and are subject to the IRA




Publication 590-A (2024)                                                                                      51
Appendix A. Summary Record of Traditional IRA(s) for
            2024                                                                                                Keep for Your Records


Name ______________________________________
I was covered not covered by my employer's retirement plan during the year.
I became age 591/2 on ______________________________________(month) (day) (year)
Contributions
                                                                                                       Check if         Fair market value of IRA as
                                                                    Amount contributed for              rollover          of December 31, 2024,
       Name of traditional IRA                     Date                    2024                       contribution            from Form 5498
1.
2.
3.
4.
...
Basis of all traditional IRAs for 2024 and earlier years (from Form 8606, line 14) . . . . . . . . . . . . .            $
Note. You should keep copies of your income tax return, and Forms W-2, 8606, and 5498.




52                                                                                                                      Publication 590-A (2024)
...
1. Adjusted gross income (AGI) from Form 1040 or 1040-SR.
   ...
   this calculation.) . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .         1.
2. Enter the amount in box 5 of all Forms SSA-1099 and RRB-1099 . . . . . . . . . . . . . . . . . . . . . . . . .                                                   2.
...
Publication 590-A (2024)                                                                                                                                                   53
Appendix B (continued)                                                                                                               Keep for Your Records
Worksheet 2
Computation of Traditional IRA Deduction for 2024
(For use only by taxpayers who receive social security benefits)
       ...
       employer plan but your
       spouse is)                                                                       $230,000*                                                     $240,000

       single, or head of
       household                                                                          $77,000*                                                    $87,000

       married filing
       separately**                                                                                $0*                                                $10,000

       * If your modified AGI isn’t over this amount, you can take an IRA deduction for your contributions of up to the lesser
       of $7,000 ($8,000 if you are age 50 or older) or your taxable compensation. Skip this worksheet, proceed to
...
4.     Multiply line 3 by the percentage below that applies to you. If the result isn’t a multiple of
       ...
       $620.) However, if the result is less than $200, enter $200.
         • Married filing jointly or qualifying surviving spouse and you
            are covered by an employer plan, multiply line 3 by 35%
             (0.35) (by 40% (0.40) if you are age 50 or older).                                             . . . . . . . . . . . . . . . . . . 4.
         • All others, multiply line 3 by 70% (0.70) (by 80% (0.80) if
...
5.     Enter your compensation minus any deductions on Schedule 1 (Form 1040), line 15
       ...
       include your spouse's compensation reduced by their traditional IRA and Roth IRA
       contributions for this year . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 5.
6.     Enter contributions you made, or plan to make, to your traditional IRA for 2024, but don’t
       enter more than $7,000 ($8,000 if you are age 50 or older). . . . . . . . . . . . . . . . . . . . . . . . . . . 6.
...
8.     Nondeductible contributions. Subtract line 7 from line 5 or line 6, whichever is smaller.
       Enter the result here and on line 1 of your Form 8606, Nondeductible IRAs . . . . . . . . . . . . 8.




54                                                                                                                                             Publication 590-A (2024)
Appendix B (continued)                                                                                                                        Keep for Your Records
Worksheet 3
...
3.     Subtract line 2 from line 1 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 3.
4.     Enter the amount in box 5 of all Forms SSA-1099 and RRB-1099 . . . . . . . . . . . . . . . . . . . . . 4.
...
Publication 590-A (2024)                                                                                                                                              55
Appendix B (continued)                                                                                                                      Keep for Your Records
Comprehensive Example
Determining Your Traditional IRA Deduction and
the Taxable Portion of Your Social Security Benefits
   You are married and file a joint return. You are 65 years old and had 2024 wages of $115,000. Your spouse didn’t work in
2024. You received social security benefits of $12,000 and made a $8,000 contribution to your traditional IRA for the year.
...
(Form 1040). You participated in a section 401(k) retirement plan at work.
  You complete Worksheets 1 and 2. Worksheet 2 shows that your 2024 IRA deduction is $7,200. You must either withdraw
the contributions that are more than the deduction amount (the $880 shown on line 8 of Worksheet 2) or treat the excess
...
1. Adjusted gross income (AGI) from Form 1040 or 1040-SR.
    ...
    IRA, any student loan interest deduction, or any exclusion of interest from savings bonds to be
    reported on Form 8815. See the Line 1 Worksheet in Appendix C for assistance with
    this calculation.) . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 1.       115,000
2. Enter the amount in box 5 of all Forms SSA-1099 and RRB-1099 . . . . . . . . . . . . . . . . . . . . . . . . . 2.                                                   12,000
...
6. Add lines 1, 3, 4, and 5 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 6.              121,000
7. Enter the amount listed below for your filing status.
      • $32,000 if you checked box A above.
      • $25,000 if you checked box B above.
      • $0 if you checked box C above . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 7.                        32,000
8. Subtract line 7 from line 6. If zero or less, enter -0- on this line . . . . . . . . . . . . . . . . . . . . . . . . . . . 8.                                        89,000
9. If line 8 is zero, skip to line 17, enter -0-, and continue with line 18.
    If line 8 is more than zero, enter the amount listed below for your filing status.
      • $12,000 if you checked box A above.
      • $9,000 if you checked box B above.
      • $0 if you checked box C above . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 9.                        12,000
10. Subtract line 9 from line 8. If zero or less, enter -0- . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 10.                               77,000
...
14. Multiply line 10 by 0.85. If line 10 is zero, enter -0- . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 14.                             65,450
15. Add lines 13 and 14 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 15.             71,450
...
19. Modified AGI for determining your reduced traditional IRA deduction—add lines 1, 17, and
    18. Enter here and on line 2 of Worksheet 2 next . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 19.                                125,200




56                                                                                                                                                     Publication 590-A (2024)
Appendix B (continued)                                                                                                               Keep for Your Records
Worksheet 2
Computation of Traditional IRA Deduction for 2024
(For use only by taxpayers who receive social security benefits)
...
1.     Enter the applicable amount from above . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 1.                             143,000
2.     Enter your modified AGI from Worksheet 1, line 19 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 2.                                      125,200
       Note. If line 2 is equal to or more than the amount on line 1, stop here; your traditional
       IRA contributions aren’t deductible. Proceed to Worksheet 3.
...
4.     Multiply line 3 by the percentage below that applies to you. If the result isn’t a multiple of
       ...
       $620.) However, if the result is less than $200, enter $200.
         • Married filing jointly or qualifying surviving spouse and you
            are covered by an employer plan, multiply line 3 by 35%
             (0.35) (by 40% (0.40) if you are age 50 or older).                                             . . . . . . . . . . . . . . . . . . 4.                 7,120
         • All others, multiply line 3 by 70% (0.70) (by 80% (0.80) if
            you are age 50 or older).
5.     Enter your compensation minus any deductions on Schedule 1 (Form 1040), line 15
       (deductible part of self-employment tax), and Schedule 1 (Form 1040), line 16
       (self-employed SEP, SIMPLE, and qualified plans). If you are the lower-income spouse,
       include your spouse's compensation reduced by their traditional IRA and Roth IRA
       contributions for this year . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 5.              115,000
6.     Enter contributions you made, or plan to make, to your traditional IRA for 2024, but don’t
       enter more than $7,000 ($8,000 if you are age 50 or older). . . . . . . . . . . . . . . . . . . . . . . . . . . 6.                                          8,000
7.     Deduction. Compare lines 4, 5, and 6. Enter the smallest amount here (or a smaller
       amount if you choose). Enter this amount on your Schedule 1 (Form 1040), line 20. (If the
       amount on line 6 is more than the amount on line 7, complete line 8.) . . . . . . . . . . . . . . . . . 7.                                                  7,120
8.     Nondeductible contributions. Subtract line 7 from line 5 or line 6, whichever is smaller.
       Enter the result here and on line 1 of your Form 8606, Nondeductible IRAs . . . . . . . . . . . . 8.                                                            880




Publication 590-A (2024)                                                                                                                                                57
Appendix B (continued)                                                                                                                               Keep for Your Records
Worksheet 3
Computation of Taxable Social Security Benefits
...
1.    Adjusted gross income (AGI) from Form 1040 or 1040-SR.
      ...
      calculation.) . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .     1.              125,200
2.    Deduction(s) from line 7 of Worksheet(s) 2 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                            2.                7,200
3.    Subtract line 2 from line 1 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .               3.              118,000
4.    Enter the amount in box 5 of all Forms SSA-1099 and RRB-1099 . . . . . . . . . . . . . . . . . . . . .                                                  4.               12,000
...
7.    Enter the amount of any tax-exempt interest reported on Form 1040 or 1040-SR,
      line 2a . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .   7.                    0
8.    Add lines 3, 5, 6, and 7 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .              8.              124,000
9.    Enter the amount listed below for your filing status.
        • $32,000 if you checked box A above.
        • $25,000 if you checked box B above.
        • $0 if you checked box C above . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                       9.                32,000
10.   Subtract line 9 from line 8. If zero or less, enter -0- on this line . . . . . . . . . . . . . . . . . . . . . . . .                                    10.               92,000
11.   If line 10 is zero, stop here. None of your social security benefits are taxable.
      If line 10 is more than zero, enter the amount listed below for your filing status.
        • $12,000 if you checked box A above.
        • $9,000 if you checked box B above.
        • $0 if you checked box C above . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                       11.               12,000
12.   Subtract line 11 from line 10. If zero or less, enter -0- . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                               12.               80,000
...
16.   Multiply line 12 by 0.85. If line 12 is zero, enter -0- . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                           16.               68,000
17.   Add lines 15 and 16 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .             17.               74,000
...
58                                                                                                                                                             Publication 590-A (2024)
                   To help us develop a more useful index, please let us know if you have ideas for index entries.
Index              See “Comments and Suggestions” in the “Introduction” for the ways you can reach us.

                                         Recharacterizing                          Deductible this year (Worksheet
10% additional tax 31                       (See Recharacterization)                 1-5) 35
20% withholding 25                       Retirement savings contributions          Deductible this year if any were
6% excise tax on excess                     credit 46                                deducted in closed tax year
  contributions to Roth IRAs 42          Roth IRAs 38-43                             (Worksheet 1-6) 37
60-day period for rollovers 21           Traditional IRAs 8-10                     Deducting in a later year 35
                                         When to contribute 10                     Due to incorrect rollover
A                                        Withdrawing before due date of              information 35
Additional taxes 32                         return 30                              Recharacterizing 29
(See also Penalties)                   Conversions:                                Roth IRAs 42
Adjusted gross income (AGI) 14,          To Roth IRAs 43                           Tax 31
   38                                  Credits                                     Withdrawn after due date of
(See also Modified adjusted gross                                                    return 34
                                         Retirement savings contributions
    income (AGI))                                                                  Withdrawn by due date of return 34
                                            credit 45-47
   Retirement savings contributions                                              Exempt transactions 32
      credit 46                        D
Age 50:                                                                          F
   Contributions 9                     Deductions
                                         Figuring reduced IRA deduction 15       Federal judges 11
Age limit:
                                         Phaseout 13                             Fiduciaries:
   Traditional IRA 10
                                         Traditional IRAs 11-16                     Prohibited transactions 32
Alimony 6
                                       Deemed IRAs 37                            Filing before IRA contribution is
Annuity contracts 9                                                                 made 11
   Borrowing on 32                     Defined benefit plans 12
                                       Defined contribution plans 11             Filing status 10
Assistance (See Tax help)                                                           Deduction phaseout and 13
                                       Difficulty of care payments:
                                         Compensation 15                         Firefighters, volunteer 12
B
                                         Nondeductible IRA contributions 15      Form 1040:
Basis:                                                                              Modified AGI calculation from 14
                                       Distributions:
  Traditional IRAs 16                                                            Form 1040-NR:
                                         Contributions in same year as 14
Bond purchase plans:                                                                Modified AGI calculation from 14
                                         Income from 14
  Rollovers from 27                                                              Form 1040-SR:
                                         Inherited IRAs (See Inherited IRAs)
Bonds, retirement (See Individual                                                   Modified AGI calculation from 14
  retirement bonds)                    Divorce:
                                         Rollovers by former spouse 27           Form 1099-R:
Broker's commissions 8, 11
                                         Transfers incident to 27                   Distribution code 1 used on 37
C                                                                                   Withdrawal of excess
                                       E                                               contribution 34
Collectibles 33                                                                  Form 5329 37
Community property 8                   Early distributions 32
                                       (See also Additional taxes)               Form 8606 15
Compensation:                                                                       Failure to file, penalty 16
                                         Tax 31
  Alimony 6                                                                      Form 8880 47
                                       Employer and employee
  Defined 6                                                                      Form W-2:
                                         association trust accounts 8
  Income included (Table 1-1) 7                                                     Employer retirement plans 11
                                       Employer plans:
  Nontaxable combat pay 6                                                        Frozen deposits 23
                                         Covered by 11
  Self-employment 6                                                              Full-time student:
                                         Year(s) covered 11
  Wages, salaries, etc. 6                                                           Retirement savings contributions
                                       Employer retirement plans 11
Conduit IRAs 26                                                                        credit 45
                                         Defined benefit plans 12
Contribution limits:                     Defined contribution plans 11
  More than one IRA 9                    Effect of modified AGI on deduction
                                                                                 H
Contributions                               (Table 1-2) 13                       How to:
  Designating the year 10                Limit if covered by 13                    Set up an IRA 7
  Distributions in same year as 14       Prohibited transactions 32                Treat withdrawn contributions 34
  Excess (See Excess contributions)    Endowment contracts (See Annuity
  Less than maximum 10                   contracts)                              I
  Nondeductible (See Nondeductible     Excess contributions 34-37                Individual retirement accounts 7
     contributions)                      Closed tax year 37                      Individual retirement annuities 7, 8
  Not required 11                        Deducted in earlier year 35
  Qualified reservist repayments 8


Publication 590-A (2024)                                                                                               59
Individual retirement arrangements    Phaseout of deduction 13               Roth IRAs 37
   (IRAs):                            Pledging account as security 32          Age limit 38
   How to set up 7                    Prohibited transactions 32, 33           Contribution limit reduced 39
   When to set up 7                     Additional taxes 32                       Determining reduced limit
Individual retirement bonds 8         Publications (See Tax help)                    (Worksheet 2-2) 42
Inherited IRAs 20                                                              Contributions 38-43
   Rollovers 24                         Q                                         Timing of 42
Interest on IRA 3                       Qualified domestic relations orders       To traditional IRAs and to Roth
Investment in collectibles:               (QDROs) 27                                 IRAs 39
   Collectibles defined 33                                                     Conversion 28, 43
   Exception 33                         R                                      Defined 38
                                        Recharacterization 28-30               Excess contributions 42
K                                         Determining amount of net income     Modified AGI:
Kay Bailey Hutchison Spousal                 due to contribution and total        Effect on contribution amount
   IRAs:                                     amount to be recharacterized            (Table 2-1) 41
   Contribution limits 9                     (Worksheet 1-3) 29                   Figuring (Worksheet 2-1) 40
   Deductions 11                          Timing of 29                         Rollovers from 45
   Roth IRA contribution limits 38      Recordkeeping requirements:            Setting up 38
Keogh plans:                              Summary record of traditional IRAs   Spouse 38
   Rollovers from 27                         for 2022 (Appendix A) 52          Traditional IRAs converted into 28
                                          Traditional IRAs 16
L                                       Reporting:                           S
Last-in first-out rule 31                 Additional   taxes  37             Section 501(c)(18) plan 9, 10
Life insurance 27                         Deductible    contributions  15    Self-certification    23
Line 1 Worksheet 58                       Recharacterization 30              Self-employed persons:
                                          Rollovers:                           Deductible contributions 15
M                                            From employer plans 27            Income of 6
                                             From IRAs 24                    Separated taxpayers:
Military death gratuities 45
Missing children, photographs of 3 Reservists 12                               Filing status of 14
                                          Qualified   reservist repayments 8 Servicemembers        group life
Modified adjusted gross income
   (AGI):                               Retirement bonds (See Individual       insurance 45
                                          retirement bonds)                  Services received at reduced or no
   Employer retirement plan coverage
      and deduction (Table 1-2) 13      Retirement     savings contributions   cost 33
                                          credit   45-47                     SIMPLE    IRAs 8
   Figuring (Worksheet 1-1) 15
                                        Rollovers    21-27                     Traditional  IRA, mistakenly moved
   No employer retirement plan
      coverage and deduction              Amount 23                               to 28
      (Table 1-3) 14                      Choosing an option (Table 1-5) 26  Simplified employee pensions
   Roth IRAs 38                           Completed after 60-day period 21     (SEPs) 8
      Effect on contribution amount       Conduit IRAs 26                    Social Security recipients 13
         (Table 2-1) 41                   Direct rollover option 26            Contributions to traditional IRAs,
More than one IRA 9                       Extension of period 23                  worksheet (Appendix B) 53, 56
   Recharacterization 30                  From   bond   purchase   plan 27   Spousal    IRAs (See Kay Bailey
                                          From employer's plan into a Roth     Hutchison Spousal IRAs or Inherited
N                                            IRA 44                            IRAs)
                                          From employer's plan into an       Students:
Nondeductible contributions 15
                                             IRA 24                            Retirement savings contributions
   Failure to report 16                                                           credit 45
   Overstatement penalty 16               From   Keogh   plans   27
                                          From one IRA into another 23       Surviving    spouse:
Notice:                                                                        Rollovers   by 27
   Qualified employer plan to provide     From Roth IRAs 45
      prior to rollover distribution 25   From traditional IRA 21
                                          Inherited IRAs 24
                                                                             T
   Rollovers 21
                                          Nonspouse beneficiary 25           Tables:
P                                         Notice 21                            Compensation, types of
                                          Partial  24,  27                        (Table 1-1) 7
Partial rollovers 24, 27                                                       Modified    AGI:
Penalties 32-37                           Tax treatment of rollover from
                                             traditional IRA to eligible          Employer    retirement plan
   Excess contributions 34-37                                                        coverage and deduction
                                             retirement plan other than an
      Roth IRAs 42                           IRA 21                                  (Table 1-2) 13
   Exempt transactions 32, 33             Time limit 21                           No employer retirement plan
   Failure to file Form 8606 16           To Roth IRAs 43                            coverage and deduction
   Overstatement of nondeductible                                                    (Table 1-3) 14
                                          To traditional IRA 21
      contributions 16                                                            Roth IRAs, effect on contribution
                                          Waiting period between 24, 26              (Table 2-1) 41
   Prohibited transactions 32, 33
                                          Withholding (See Withholding)

60                                                                                       Publication 590-A (2024)
  Rollover vs. direct payment to           Rollovers (See Rollovers)               Traditional IRAs 30, 31
  ...
  Using this publication (Table I-1) 4     Social Security recipients 13, 53,      Direct rollover option 26
...
Tax credits                                Summary record for 2022                    taxpayer 25
  Retirement savings contributions            (Appendix A) 52                    Worksheets:
     credit 45-47                          Transfers 20                            Excess contributions deductible this
Tax help 47                                Types of 7                                 year (Worksheet 1-5) 35
...
Traditional IRAs 6-37                      To Roth IRAs 20, 43                        to IRA contribution and total
  ...
  Excess contributions 34-37                                                          Figuring reduced contribution
  Inherited IRAs 20                      W                                                limit (Worksheet 2-2) 42
  Loss of IRA status 32                                                            Social Security recipients who
                                         Withdrawing or using assets
  Mistakenly moved to SIMPLE                                                          contribute to traditional IRAs
                                           Contribution withdrawal, before due        (Appendix B) 53, 56
     IRA 28                                  date of return 30
  Recordkeeping 16                         Determining total amount to be
  Reduced IRA deduction for                  withdrawn (Worksheet 1-4) 31
     2021 16




Publication 590-A (2024)                                                                                              61
